...
//            NSLog(@" location %lu", (unsigned long)range.location);
            if ([string isEqualToString:tempString])
            {
                ...
                NSLog(@"the letter is %@", [tempString uppercaseString]);
...
//-(void) reverseTwo:(NSString*)string{
//    for (NSInteger i = string.length ; string.length > 0; i--) {
//        <#statements#>
//    }
//
//}

#pragma mark - UITextFeildDelegates
